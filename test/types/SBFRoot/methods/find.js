...
describe('SBFRoot - methods - find', () => {
  ...
  it('should find using $in operator', async function () {
    ...
    expect(res).to.deep.equal(['5d6ebb7e21f1df6ff7482621'])
    const res2 = await find.call(fakeSelf, [33], '$in');
    expect(res2).to.deep.equal(['5d6ebb7e21f1df6ff7482631'])

    const res3 = await find.call(fakeSelf, [45], '$in');
    expect(res3).to.deep.equal(['5d6ebb7e21f1df6ff7482641'])
  ...
  it('should find using $nin operator',async function () {
      ...
      expect(res).to.deep.equal(['5d6ebb7e21f1df6ff7482631','5d6ebb7e21f1df6ff7482641'])
      const res2 = await find.call(fakeSelf, [33], '$nin');
      expect(res2).to.deep.equal(['5d6ebb7e21f1df6ff7482621','5d6ebb7e21f1df6ff7482641'])

      const res3 = await find.call(fakeSelf, [45], '$nin');
      expect(res3).to.deep.equal(['5d6ebb7e21f1df6ff7482621','5d6ebb7e21f1df6ff7482631'])
      ...
      expect(res5).to.be.deep.equal(['5d6ebb7e21f1df6ff7482621', '5d6ebb7e21f1df6ff7482631', '5d6ebb7e21f1df6ff7482641']);
  });
